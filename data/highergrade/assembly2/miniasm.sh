...
overlap_file="/home/jili2251/genome_analysis_project/data/highergrade/assembly2/reads.paf"


# Assemble using Miniasm
miniasm -f $reads_path $overlap_file > /home/jili2251/genome_analysis_project/data/highergrade/assembly2/assembly.gfa
